...
namespace Shuile.UI.Menu
{
    public class SettingPanelController : MonoBehaviour
    {
        ...
        {
            if (Mathf.Abs(value) > MAX_LATENCY)
            {
                return;
            }
        ...
        private void ConfigureButtonEvent()
        {
            ...
            btn_LatencyAdd.onClick.AddListener(() =>
                UpdateLatency(_configViewer.Data.GlobalDelay + LATENCY_LARGE_STEP));
            btn_LatencyMinus.onClick.AddListener(() =>
                UpdateLatency(_configViewer.Data.GlobalDelay - LATENCY_LARGE_STEP));
        }
    }
}
