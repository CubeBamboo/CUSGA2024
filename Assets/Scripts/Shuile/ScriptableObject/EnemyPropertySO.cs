...
{
    [Header("Base property")] public int healthPoint;

    public int attackPoint;

    [Header("Behaviour")] public int attackRange;

    [Tooltip("攻击前摇拍数")] public int preAttackDuration = 1;
    [Tooltip("攻击后摇拍数")] public int postAttackDuration;

    [Header("Move Behaviour")] [Tooltip("0则代表每一拍都会试图移动")]
